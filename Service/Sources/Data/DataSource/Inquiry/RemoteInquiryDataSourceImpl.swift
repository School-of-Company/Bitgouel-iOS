...
public final class RemoteInquiryDataSourceImpl: BaseRemoteDataSource<InquiryAPI>, RemoteInquiryDataSource {
    ...
    public func fetchInquiryListByAdmin(answerStatus: AnswerStatusType, keyword: String) async throws -> [InquiryInfoEntity] {
        try await request(.fetchInquiryListByAdmin(answerStatus: answerStatus, keyword: keyword), dto: FetchInquiryListResponseDTO.self).toDomain()
    }
