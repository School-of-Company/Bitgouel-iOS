...
public extension ListSelectButton {
    enum SelectButtonStyleType {
        case select
    }
}

public struct ListSelectButtonStyle: ButtonStyle {
    var style: ListSelectButton.SelectButtonStyleType
...
private extension ListSelectButtonStyle {
