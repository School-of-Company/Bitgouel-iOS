                        ...
                        VStack(alignment: .leading, spacing: 16) {
                            ...
                            LazyVStack(alignment: .leading, spacing: 16) {
                                ForEach(lectureDetail.lectureDates, id: \.completeDate) { lectureDate in
                                    Text("• \(lectureDate.completeDate.toStringCustomFormat(format: "yyyy년 MM월 dd일")) \(lectureDate.startTime.toStringCustomFormat(format: "H시 m분"))~\(lectureDate.endTime.toStringCustomFormat(format: "H시m분"))")
                                }
                            }
                            .bitgouelFont(.text3, color: .greyscale(.g4))
                        }
