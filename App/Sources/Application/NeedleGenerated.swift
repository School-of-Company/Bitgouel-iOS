...
extension AppComponent: Registration {
    public func registerItems() {
        ...
        localTable["searchInstructorListUseCase-any SearchInstructorListUseCase"] = { [unowned self] in
            self.searchInstructorListUseCase as Any
        }
        localTable["searchLineListUseCase-any SearchLineListUseCase"] = { [unowned self] in
            self.searchLineListUseCase as Any
        }
        localTable["searchDepartmentListUseCase-any SearchDepartmentListUseCase"] = { [unowned self] in
            self.searchDepartmentListUseCase as Any
        }
