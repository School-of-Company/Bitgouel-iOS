...
private class MyPageDependency48d84b530313b3ee40feProvider: MyPageDependency {
    ...
    var saveUserIDUseCase: any SaveUserIDUseCase {
        return appComponent.saveUserIDUseCase
    }
...
extension MyPageComponent: Registration {
    public func registerItems() {
        ...
        keyPathToName[\MyPageDependency.loadUserAuthorityUseCase] =
            "loadUserAuthorityUseCase-any LoadUserAuthorityUseCase"
        keyPathToName[\MyPageDependency.saveUserIDUseCase] = "saveUserIDUseCase-any SaveUserIDUseCase"
...
extension LectureDetailSettingComponent: Registration {
    public func registerItems() {
        keyPathToName[\LectureDetailSettingDependency.openLectureApplyFactory] =
...
extension ClubDetailComponent: Registration {
    public func registerItems() {
        keyPathToName[\ClubdetailDependency.certificationListFactory] =
        ...
        keyPathToName[\ClubdetailDependency.saveUserIDUseCase] = "saveUserIDUseCase-any SaveUserIDUseCase"
...
extension CertificationListComponent: Registration {
    public func registerItems() {
        ...
        keyPathToName[\CertificationListDependency.loadUserAuthorityUseCase] =
            "loadUserAuthorityUseCase-any LoadUserAuthorityUseCase"
        keyPathToName[\CertificationListDependency.queryStudentDetailByClubUseCase] =
            "queryStudentDetailByClubUseCase-any QueryStudentDetailByClubUseCase"
        keyPathToName[\CertificationListDependency.queryCertificationListByStudentUseCase] =
            "queryCertificationListByStudentUseCase-any QueryCertificationListByStudentUseCase"
        keyPathToName[\CertificationListDependency.queryCertificationListByTeacherUseCase] =
            "queryCertificationListByTeacherUseCase-any QueryCertificationListByTeacherUseCase"
        keyPathToName[\CertificationListDependency.inputCertificationFactory] =
...
extension LectureListComponent: Registration {
    public func registerItems() {
        ...
        keyPathToName[\LectureListDependency.openLectureApplyFactory] =
            "openLectureApplyFactory-any OpenLectureApplyFactory"
...
extension OpenLectureApplyComponent: Registration {
    public func registerItems() {
        ...
        keyPathToName[\OpenLectureApplyDependency.lectureDetailSettingFactory] =
...
extension AppComponent: Registration {
    public func registerItems() {
        ...
        localTable["saveUserIDUseCase-any SaveUserIDUseCase"] = { [unowned self] in self.saveUserIDUseCase as Any }
        localTable["loadUserIDUseCase-any LoadUserIDUseCase"] = { [unowned self] in self.loadUserIDUseCase as Any }
        ...
        localTable["openLectureApplyFactory-any OpenLectureApplyFactory"] = { [unowned self] in
            self.openLectureApplyFactory as Any
        }
        ...
        localTable["certificationListFactory-any CertificationListFactory"] = { [unowned self] in
            self.certificationListFactory as Any
        }
...
@inline(never) private func register1() {
    ...
    registerProviderFactory(
        "^->AppComponent->CertificationListComponent",
        factoryc231b853779286e489fbf47b58f8f304c97af4d5
    )
    registerProviderFactory(
        "^->AppComponent->AdminWithdrawUserListComponent",
    ...
    registerProviderFactory(
        "^->AppComponent->OpenLectureApplyComponent",
        factory0e26cbbc0f01f86f2b04f47b58f8f304c97af4d5
    )
