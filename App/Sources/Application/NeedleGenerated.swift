...
extension LectureListDetailComponent: Registration {
    public func registerItems() {
        keyPathToName[\LectureListDetailDependency.queryLectureDetailUseCase] =
        ...
        keyPathToName[\LectureListDetailDependency.lectureCancelUseCase] =
...
extension LectureListComponent: Registration {
    public func registerItems() {
        ...
        keyPathToName[\LectureListDependency.loadUserAuthorityUseCase] =
            "loadUserAuthorityUseCase-any LoadUserAuthorityUseCase"
        keyPathToName[\LectureListDependency.queryLectureListUseCase] =
...
extension ActivityDetailComponent: Registration {
    public func registerItems() {
        keyPathToName[\ActivityDetailDependency.loadUserAuthorityUseCase] =
            "loadUserAuthorityUseCase-any LoadUserAuthorityUseCase"
        keyPathToName[\ActivityDetailDependency.queryStudentActivityDetailsUseCase] =
            "queryStudentActivityDetailsUseCase-any QueryStudentActivityDetailsUseCase"
        keyPathToName[\ActivityDetailDependency.approveStudentActivityUseCase] =
            "approveStudentActivityUseCase-any ApproveStudentActivityUseCase"
        keyPathToName[\ActivityDetailDependency.rejectStudentActivityUseCase] =
            "rejectStudentActivityUseCase-any RejectStudentActivityUseCase"
        keyPathToName[\ActivityDetailDependency.deleteStudentActivityUseCase] =
...
extension AppComponent: Registration {
    public func registerItems() {
        ...
        localTable["queryLectureListUseCase-any QueryLectureListUseCase"] = { [unowned self] in
            self.queryLectureListUseCase as Any
        }
        localTable["queryLectureDetailUseCase-any QueryLectureDetailUseCase"] = { [unowned self] in
            self.queryLectureDetailUseCase as Any
        }
        localTable["lectureApplyUseCase-any LectureApplyUseCase"] = { [unowned self] in
            self.lectureApplyUseCase as Any
        }
        localTable["lectureCancelUseCase-any LectureCancelUseCase"] = { [unowned self] in
            self.lectureCancelUseCase as Any
        }
        ...
        localTable["rejectStudentActivityUseCase-any RejectStudentActivityUseCase"] = { [unowned self] in
            self.rejectStudentActivityUseCase as Any
        }
