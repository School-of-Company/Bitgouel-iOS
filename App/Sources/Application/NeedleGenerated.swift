...
private func factoryde3552d9e0f793ec8b8df47b58f8f304c97af4d5(_ component: NeedleFoundation.Scope) -> AnyObject {
    return SuccessChangePasswordDependency05dde412f91beb4c3b8dProvider(
...
extension InputPostComponent: Registration {
    public func registerItems() {
        keyPathToName[\InputPostDependency.postDetailSettingFactory] =
...
extension InputCertificationComponent: Registration {
    public func registerItems() {
        keyPathToName[\InputCertificationDependency.inputCertificationUseCase] =
            "inputCertificationUseCase-any InputCertificationUseCase"
        keyPathToName[\InputCertificationDependency.updateCertificationUseCase] =
...
extension ClubListComponent: Registration {
    public func registerItems() {
        ...
        keyPathToName[\ClubListDependency.loadUserAuthorityUseCase] =
...
extension LectureListDetailComponent: Registration {
    public func registerItems() {
        keyPathToName[\LectureListDetailDependency.fetchLectureDetailUseCase] =
        ...
        keyPathToName[\LectureListDetailDependency.cancelLectureApplicationUseCase] =
            "cancelLectureApplicationUseCase-any CancelLectureApplicationUseCase"
        keyPathToName[\LectureListDetailDependency.loadUserAuthorityUseCase] =
            "loadUserAuthorityUseCase-any LoadUserAuthorityUseCase"
        ...
        keyPathToName[\LectureListDetailDependency.deleteLectureUseCase] =
...
extension OrganizationListComponent: Registration {
    public func registerItems() {
        keyPathToName[\OrganizationListDependency.fetchCompanyListUseCase] =
            "fetchCompanyListUseCase-any FetchCompanyListUseCase"
        keyPathToName[\OrganizationListDependency.deleteCompanyUseCase] =
            "deleteCompanyUseCase-any DeleteCompanyUseCase"
        keyPathToName[\OrganizationListDependency.inputOrganizationFactory] =
            "inputOrganizationFactory-any InputOrganizationFactory"
        keyPathToName[\OrganizationListDependency.fetchGovernmentListUseCase] =
            "fetchGovernmentListUseCase-any FetchGovernmentListUseCase"
        keyPathToName[\OrganizationListDependency.deleteGovernmentUseCase] =
...
extension NoticeListComponent: Registration {
    public func registerItems() {
        ...
        keyPathToName[\NoticeListDependency.loadUserAuthorityUseCase] =
            "loadUserAuthorityUseCase-any LoadUserAuthorityUseCase"
    }
}
...
extension SignUpComponent: Registration {
    public func registerItems() {
        ...
        keyPathToName[\SignUpDependency.companyInstructorSignupUseCase] =
        ...
        keyPathToName[\SignUpDependency.fetchAllSchoolNameUseCase] =
        ...
        keyPathToName[\SignUpDependency.fetchUniversityListUseCase] =
            "fetchUniversityListUseCase-any FetchUniversityListUseCase"
        keyPathToName[\SignUpDependency.fetchGovernmentListUseCase] =
            "fetchGovernmentListUseCase-any FetchGovernmentListUseCase"
    }
}
...
extension MyPageComponent: Registration {
    public func registerItems() {
        ...
        keyPathToName[\MyPageDependency.loadUserAuthorityUseCase] =
            "loadUserAuthorityUseCase-any LoadUserAuthorityUseCase"
...
extension AdminRootComponent: Registration {
    public func registerItems() {
        ...
        keyPathToName[\AdminRootDependency.requestUserSignupFactory] =
            "requestUserSignupFactory-any RequestUserSignupFactory"
        keyPathToName[\AdminRootDependency.withdrawUserListFactory] =
        ...
        keyPathToName[\AdminRootDependency.organizationListFactory] =
...
extension InquiryDetailComponent: Registration {
    public func registerItems() {
        ...
        keyPathToName[\InquiryDetailDependency.writeInquiryAnswerFactory] =
            "writeInquiryAnswerFactory-any WriteInquiryAnswerFactory"
        keyPathToName[\InquiryDetailDependency.fetchInquiryDetailUseCase] =
            "fetchInquiryDetailUseCase-any FetchInquiryDetailUseCase"
        keyPathToName[\InquiryDetailDependency.loadUserAuthorityUseCase] =
            "loadUserAuthorityUseCase-any LoadUserAuthorityUseCase"
        keyPathToName[\InquiryDetailDependency.deleteMyInquiryUseCase] =
            "deleteMyInquiryUseCase-any DeleteMyInquiryUseCase"
        keyPathToName[\InquiryDetailDependency.deleteInquiryByAdminUseCase] =
...
extension InputNoticeComponent: Registration {
    public func registerItems() {
        keyPathToName[\InputNoticeDependency.noticeDetailSettingFactory] =
            "noticeDetailSettingFactory-any NoticeDetailSettingFactory"
        keyPathToName[\InputNoticeDependency.fetchPostDetailUseCase] =
...
extension LectureDetailSettingComponent: Registration {
    public func registerItems() {
        keyPathToName[\LectureDetailSettingDependency.inputLectureFactory] =
            "inputLectureFactory-any InputLectureFactory"
        keyPathToName[\LectureDetailSettingDependency.searchInstructorUseCase] =
        ...
        keyPathToName[\LectureDetailSettingDependency.searchDepartmentUseCase] =
            "searchDepartmentUseCase-any SearchDepartmentUseCase"
        keyPathToName[\LectureDetailSettingDependency.searchDivisionUseCase] =
...
extension MainComponent: Registration {
    public func registerItems() {
        ...
        keyPathToName[\MainDependency.loadUserAuthorityUseCase] =
            "loadUserAuthorityUseCase-any LoadUserAuthorityUseCase"
...
extension RequestUserSignupComponent: Registration {
    public func registerItems() {
        ...
        keyPathToName[\RequestUserSignupDependency.withdrawUserListFactory] =
            "withdrawUserListFactory-any WithdrawUserListFactory"
        keyPathToName[\RequestUserSignupDependency.fetchUserListUseCase] =
            "fetchUserListUseCase-any FetchUserListUseCase"
        keyPathToName[\RequestUserSignupDependency.approveUserSignupUseCase] =
            "approveUserSignupUseCase-any ApproveUserSignupUseCase"
        keyPathToName[\RequestUserSignupDependency.rejectUserSignupUseCase] =
...
extension PostListComponent: Registration {
    public func registerItems() {
        ...
        keyPathToName[\PostListDependency.loadUserAuthorityUseCase] =
            "loadUserAuthorityUseCase-any LoadUserAuthorityUseCase"
...
extension ChangePasswordComponent: Registration {
    public func registerItems() {
        keyPathToName[\ChangePasswordDependency.successChangePasswordFactory] =
            "successChangePasswordFactory-any SuccessChangePasswordFactory"
        keyPathToName[\ChangePasswordDependency.changePasswordUseCase] =
...
extension ClubDetailComponent: Registration {
    public func registerItems() {
        ...
        keyPathToName[\ClubdetailDependency.loadUserAuthorityUseCase] =
            "loadUserAuthorityUseCase-any LoadUserAuthorityUseCase"
        keyPathToName[\ClubdetailDependency.fetchClubDetailUseCase] =
            "fetchClubDetailUseCase-any FetchClubDetailUseCase"
        keyPathToName[\ClubdetailDependency.fetchStudentListByClubUseCase] =
...
extension WithdrawUserListComponent: Registration {
    public func registerItems() {
        ...
        keyPathToName[\WithdrawUserListDependency.requestUserSignupFactory] =
            "requestUserSignupFactory-any RequestUserSignupFactory"
        keyPathToName[\WithdrawUserListDependency.fetchWithdrawUserListUseCase] =
...
extension InputSchoolComponent: Registration {
    public func registerItems() {
        ...
        keyPathToName[\InputSchoolDependency.fetchSchoolDetailUseCase] =
...
extension FindPasswordComponent: Registration {
    public func registerItems() {
        keyPathToName[\FindPasswordDependency.sendEmailCertificationLinkUseCase] =
            "sendEmailCertificationLinkUseCase-any SendEmailCertificationLinkUseCase"
        keyPathToName[\FindPasswordDependency.fetchEmailVertificationStatusUseCase] =
...
extension LectureApplicantListComponent: Registration {
    public func registerItems() {
        keyPathToName[\LectureApplicantListDependency.fetchApplicantListUseCase] =
            "fetchApplicantListUseCase-any FetchApplicantListUseCase"
        keyPathToName[\LectureApplicantListDependency.setLectureCompletionUseCase] =
            "setLectureCompletionUseCase-any SetLectureCompletionUseCase"
        keyPathToName[\LectureApplicantListDependency.fetchAppliedLectureStudentDetailUseCase] =
...
extension UserListComponent: Registration {
    public func registerItems() {
        keyPathToName[\UserListDependency.requestUserSignupFactory] =
            "requestUserSignupFactory-any RequestUserSignupFactory"
        keyPathToName[\UserListDependency.withdrawUserListFactory] =
            "withdrawUserListFactory-any WithdrawUserListFactory"
...
extension StudentInfoComponent: Registration {
    public func registerItems() {
        ...
        keyPathToName[\StudentInfoDependency.inputCertificationFactory] =
            "inputCertificationFactory-any InputCertificationFactory"
        keyPathToName[\StudentInfoDependency.loadUserAuthorityUseCase] =
            "loadUserAuthorityUseCase-any LoadUserAuthorityUseCase"
        keyPathToName[\StudentInfoDependency.fetchStudentDetailByClubUseCase] =
            "fetchStudentDetailByClubUseCase-any FetchStudentDetailByClubUseCase"
        keyPathToName[\StudentInfoDependency.fetchCertificationListByStudentUseCase] =
            "fetchCertificationListByStudentUseCase-any FetchCertificationListByStudentUseCase"
        keyPathToName[\StudentInfoDependency.fetchCertificationListByTeacherUseCase] =
            "fetchCertificationListByTeacherUseCase-any FetchCertificationListByTeacherUseCase"
        keyPathToName[\StudentInfoDependency.fetchAppliedLectureListUseCase] =
...
extension UniversityListComponent: Registration {
    public func registerItems() {
        keyPathToName[\UniversityListDependency.fetchUniversityListUseCase] =
            "fetchUniversityListUseCase-any FetchUniversityListUseCase"
        keyPathToName[\UniversityListDependency.inputUniversityFactory] =
...
extension PostDetailComponent: Registration {
    public func registerItems() {
        ...
        keyPathToName[\PostDetailDependency.fetchPostDetailUseCase] =
            "fetchPostDetailUseCase-any FetchPostDetailUseCase"
...
extension InquiryListComponent: Registration {
    public func registerItems() {
        ...
        keyPathToName[\InquiryListDependency.loadUserAuthorityUseCase] =
            "loadUserAuthorityUseCase-any LoadUserAuthorityUseCase"
        keyPathToName[\InquiryListDependency.fetchMyInquiryListUseCase] =
            "fetchMyInquiryListUseCase-any FetchMyInquiryListUseCase"
        keyPathToName[\InquiryListDependency.fetchInquiryByAdminUseCase] =
...
extension SchoolListComponent: Registration {
    public func registerItems() {
        keyPathToName[\SchoolListDependency.fetchSchoolListUseCase] =
            "fetchSchoolListUseCase-any FetchSchoolListUseCase"
        keyPathToName[\SchoolListDependency.fetchSchoolDetailUseCase] =
            "fetchSchoolDetailUseCase-any FetchSchoolDetailUseCase"
...
extension ActivityListComponent: Registration {
    public func registerItems() {
        ...
        keyPathToName[\ActivityListDependency.loadUserAuthorityUseCase] =
            "loadUserAuthorityUseCase-any LoadUserAuthorityUseCase"
        keyPathToName[\ActivityListDependency.fetchMyActivityUseCase] =
            "fetchMyActivityUseCase-any FetchMyActivityUseCase"
        keyPathToName[\ActivityListDependency.fetchActivityByIDUseCase] =
...
extension InputLectureComponent: Registration {
    public func registerItems() {
        ...
        keyPathToName[\InputLectureDependency.lectureDetailSettingFactory] =
            "lectureDetailSettingFactory-any LectureDetailSettingFactory"
        keyPathToName[\InputLectureDependency.fetchLectureDetailUseCase] =
            "fetchLectureDetailUseCase-any FetchLectureDetailUseCase"
...
extension InputUniversityComponent: Registration {
    public func registerItems() {
        keyPathToName[\InputUniversityDependency.createdUniversityUseCase] =
            "createdUniversityUseCase-any CreatedUniversityUseCase"
        keyPathToName[\InputUniversityDependency.modifyUniversityUseCase] =
            "modifyUniversityUseCase-any ModifyUniversityUseCase"
        keyPathToName[\InputUniversityDependency.deleteUniversityUseCase] =
            "deleteUniversityUseCase-any DeleteUniversityUseCase"
        keyPathToName[\InputUniversityDependency.createdDepartmentUseCase] =
            "createdDepartmentUseCase-any CreatedDepartmentUseCase"
        keyPathToName[\InputUniversityDependency.deleteDepartmentUseCase] =
...
extension LectureListComponent: Registration {
    public func registerItems() {
        keyPathToName[\LectureListDependency.lectureListDetailFactory] =
        ...
        keyPathToName[\LectureListDependency.loadUserAuthorityUseCase] =
            "loadUserAuthorityUseCase-any LoadUserAuthorityUseCase"
        keyPathToName[\LectureListDependency.fetchLectureListUseCase] =
...
extension ActivityDetailComponent: Registration {
    public func registerItems() {
        ...
        keyPathToName[\ActivityDetailDependency.loadUserAuthorityUseCase] =
            "loadUserAuthorityUseCase-any LoadUserAuthorityUseCase"
        keyPathToName[\ActivityDetailDependency.fetchActivityDetailUseCase] =
            "fetchActivityDetailUseCase-any FetchActivityDetailUseCase"
        keyPathToName[\ActivityDetailDependency.deleteActivityUseCase] =
...
extension NoticeDetailViewComponent: Registration {
    public func registerItems() {
        ...
        keyPathToName[\NoticeDetailDependency.fetchPostDetailUseCase] =
            "fetchPostDetailUseCase-any FetchPostDetailUseCase"
...
extension InputOrganizationComponent: Registration {
    public func registerItems() {
        keyPathToName[\InputOrganizationDependency.createdCompanyUseCase] =
            "createdCompanyUseCase-any CreatedCompanyUseCase"
        keyPathToName[\InputOrganizationDependency.createdGovernmentUseCase] =
...
extension InputInquiryComponent: Registration {
    public func registerItems() {
        ...
        keyPathToName[\InputInquiryDependency.modifyMyInquiryUseCase] =
            "modifyMyInquiryUseCase-any ModifyMyInquiryUseCase"
        keyPathToName[\InputInquiryDependency.fetchInquiryDetailUseCase] =
            "fetchInquiryDetailUseCase-any FetchInquiryDetailUseCase"
    }
}
...
extension InputActivityComponent: Registration {
    public func registerItems() {
        ...
        keyPathToName[\InputActivityDependency.fetchActivityDetailUseCase] =
            "fetchActivityDetailUseCase-any FetchActivityDetailUseCase"
        keyPathToName[\InputActivityDependency.inputActivityUseCase] = "inputActivityUseCase-any InputActivityUseCase"
        keyPathToName[\InputActivityDependency.modifyActivityUseCase] =
...
extension AppComponent: Registration {
    public func registerItems() {
        ...
        localTable["fetchLectureListUseCase-any FetchLectureListUseCase"] = { [unowned self] in
            self.fetchLectureListUseCase as Any
        }
        localTable["fetchLectureDetailUseCase-any FetchLectureDetailUseCase"] = { [unowned self] in
            self.fetchLectureDetailUseCase as Any
        }
        localTable["applyLectureUseCase-any ApplyLectureUseCase"] = { [unowned self] in
            self.applyLectureUseCase as Any
        }
        localTable["cancelLectureApplicationUseCase-any CancelLectureApplicationUseCase"] = { [unowned self] in
            self.cancelLectureApplicationUseCase as Any
        }
        localTable["searchInstructorUseCase-any SearchInstructorUseCase"] = { [unowned self] in
            self.searchInstructorUseCase as Any
        }
        localTable["searchLineUseCase-any SearchLineUseCase"] = { [unowned self] in self.searchLineUseCase as Any }
        localTable["searchDepartmentUseCase-any SearchDepartmentUseCase"] = { [unowned self] in
            self.searchDepartmentUseCase as Any
        }
        localTable["searchDivisionUseCase-any SearchDivisionUseCase"] = { [unowned self] in
            self.searchDivisionUseCase as Any
        }
        localTable["fetchAppliedLectureListUseCase-any FetchAppliedLectureListUseCase"] = { [unowned self] in
            self.fetchAppliedLectureListUseCase as Any
        }
        localTable["fetchApplicantListUseCase-any FetchApplicantListUseCase"] = { [unowned self] in
            self.fetchApplicantListUseCase as Any
        }
        localTable["setLectureCompletionUseCase-any SetLectureCompletionUseCase"] = { [unowned self] in
            self.setLectureCompletionUseCase as Any
        }
        localTable["deleteLectureUseCase-any DeleteLectureUseCase"] = { [unowned self] in
            self.deleteLectureUseCase as Any
        }
        localTable["modifyLectureUseCase-any ModifyLectureUseCase"] = { [unowned self] in
            self.modifyLectureUseCase as Any
        }
        localTable["fetchAppliedLectureStudentDetailUseCase-any FetchAppliedLectureStudentDetailUseCase"] =
            { [unowned self] in self.fetchAppliedLectureStudentDetailUseCase as Any }
        ...
        localTable["fetchClubListUseCase-any FetchClubListUseCase"] = { [unowned self] in
            self.fetchClubListUseCase as Any
        }
        localTable["fetchClubDetailUseCase-any FetchClubDetailUseCase"] = { [unowned self] in
            self.fetchClubDetailUseCase as Any
        }
        localTable["fetchStudentListByClubUseCase-any FetchStudentListByClubUseCase"] = { [unowned self] in
            self.fetchStudentListByClubUseCase as Any
        }
        localTable["fetchStudentDetailByClubUseCase-any FetchStudentDetailByClubUseCase"] = { [unowned self] in
            self.fetchStudentDetailByClubUseCase as Any
        }
        ...
        localTable["fetchAllClubNameUseCase-any FetchAllClubNameUseCase"] = { [unowned self] in
            self.fetchAllClubNameUseCase as Any
        }
        localTable["remoteGovernmentDataSource-any RemoteGovernmentDataSource"] = { [unowned self] in
            self.remoteGovernmentDataSource as Any
        }
        localTable["governmentRepository-any GovernmentRepository"] = { [unowned self] in
            self.governmentRepository as Any
        }
        localTable["fetchGovernmentListUseCase-any FetchGovernmentListUseCase"] = { [unowned self] in
            self.fetchGovernmentListUseCase as Any
        }
        localTable["createdGovernmentUseCase-any CreatedGovernmentUseCase"] = { [unowned self] in
            self.createdGovernmentUseCase as Any
        }
        localTable["deleteGovernmentUseCase-any DeleteGovernmentUseCase"] = { [unowned self] in
            self.deleteGovernmentUseCase as Any
        }
        localTable["remotePostDataSource-any RemotePostDataSource"] = { [unowned self] in
            self.remotePostDataSource as Any
        }
        ...
        localTable["fetchPostListUseCase-any FetchPostListUseCase"] = { [unowned self] in
            self.fetchPostListUseCase as Any
        }
        localTable["fetchPostDetailUseCase-any FetchPostDetailUseCase"] = { [unowned self] in
            self.fetchPostDetailUseCase as Any
        }
        ...
        localTable["remoteInquiryDataSource-RemoteInquiryDataSource"] = { [unowned self] in
            self.remoteInquiryDataSource as Any
        }
        localTable["inquiryRepository-InquiryRepository"] = { [unowned self] in self.inquiryRepository as Any }
        localTable["inputInquiryUseCase-any InputInquiryUseCase"] = { [unowned self] in
            self.inputInquiryUseCase as Any
        }
        localTable["fetchMyInquiryListUseCase-any FetchMyInquiryListUseCase"] = { [unowned self] in
            self.fetchMyInquiryListUseCase as Any
        }
        localTable["fetchInquiryDetailUseCase-any FetchInquiryDetailUseCase"] = { [unowned self] in
            self.fetchInquiryDetailUseCase as Any
        }
        localTable["deleteMyInquiryUseCase-any DeleteMyInquiryUseCase"] = { [unowned self] in
            self.deleteMyInquiryUseCase as Any
        }
        localTable["modifyMyInquiryUseCase-any ModifyMyInquiryUseCase"] = { [unowned self] in
            self.modifyMyInquiryUseCase as Any
        }
        localTable["replyInquiryUseCase-any ReplyInquiryUseCase"] = { [unowned self] in
            self.replyInquiryUseCase as Any
        }
        localTable["fetchInquiryByAdminUseCase-any FetchInquiryByAdminUseCase"] = { [unowned self] in
            self.fetchInquiryByAdminUseCase as Any
        }
        localTable["deleteInquiryByAdminUseCase-any DeleteInquiryByAdminUseCase"] = { [unowned self] in
            self.deleteInquiryByAdminUseCase as Any
        }
        ...
        localTable["findPasswordUseCase-any FindPasswordUseCase"] = { [unowned self] in
            self.findPasswordUseCase as Any
        }
        localTable["remoteActivityDataSource-any RemoteActivityDataSource"] = { [unowned self] in
            self.remoteActivityDataSource as Any
        }
        localTable["activityRepository-any ActivityRepository"] = { [unowned self] in self.activityRepository as Any }
        localTable["inputActivityUseCase-any InputActivityUseCase"] = { [unowned self] in
            self.inputActivityUseCase as Any
        }
        localTable["modifyActivityUseCase-any ModifyActivityUseCase"] = { [unowned self] in
            self.modifyActivityUseCase as Any
        }
        localTable["deleteActivityUseCase-any DeleteActivityUseCase"] = { [unowned self] in
            self.deleteActivityUseCase as Any
        }
        localTable["fetchMyActivityUseCase-any FetchMyActivityUseCase"] = { [unowned self] in
            self.fetchMyActivityUseCase as Any
        }
        localTable["fetchActivityByIDUseCase-any FetchActivityByIDUseCase"] = { [unowned self] in
            self.fetchActivityByIDUseCase as Any
        }
        localTable["fetchActivityListUseCase-any FetchActivityListUseCase"] = { [unowned self] in
            self.fetchActivityListUseCase as Any
        }
        localTable["fetchActivityDetailUseCase-any FetchActivityDetailUseCase"] = { [unowned self] in
            self.fetchActivityDetailUseCase as Any
        }
        localTable["remoteAdminDataSource-any RemoteAdminDataSource"] = { [unowned self] in
            self.remoteAdminDataSource as Any
        }
        localTable["adminRepository-any AdminRepository"] = { [unowned self] in self.adminRepository as Any }
        localTable["fetchUserListUseCase-any FetchUserListUseCase"] = { [unowned self] in
            self.fetchUserListUseCase as Any
        }
        localTable["fetchUserDetailUseCase-any FetchUserDetailUseCase"] = { [unowned self] in
            self.fetchUserDetailUseCase as Any
        }
        localTable["approveUserSignupUseCase-any ApproveUserSignupUseCase"] = { [unowned self] in
            self.approveUserSignupUseCase as Any
        }
        localTable["rejectUserSignupUseCase-any RejectUserSignupUseCase"] = { [unowned self] in
            self.rejectUserSignupUseCase as Any
        }
        localTable["withdrawUserUseCase-any WithdrawUserUseCase"] = { [unowned self] in
            self.withdrawUserUseCase as Any
        }
        ...
        localTable["remoteUniversityDataSource-any RemoteUniversityDataSource"] = { [unowned self] in
            self.remoteUniversityDataSource as Any
        }
        localTable["universityRepository-any UniversityRepository"] = { [unowned self] in
            self.universityRepository as Any
        }
        localTable["fetchUniversityListUseCase-any FetchUniversityListUseCase"] = { [unowned self] in
            self.fetchUniversityListUseCase as Any
        }
        localTable["createdUniversityUseCase-any CreatedUniversityUseCase"] = { [unowned self] in
            self.createdUniversityUseCase as Any
        }
        localTable["modifyUniversityUseCase-any ModifyUniversityUseCase"] = { [unowned self] in
            self.modifyUniversityUseCase as Any
        }
        localTable["deleteUniversityUseCase-any DeleteUniversityUseCase"] = { [unowned self] in
            self.deleteUniversityUseCase as Any
        }
        localTable["createdDepartmentUseCase-any CreatedDepartmentUseCase"] = { [unowned self] in
            self.createdDepartmentUseCase as Any
        }
        localTable["deleteDepartmentUseCase-any DeleteDepartmentUseCase"] = { [unowned self] in
            self.deleteDepartmentUseCase as Any
        }
        ...
        localTable["successSignUpFactory-any SuccessSignUpFactory"] = { [unowned self] in
            self.successSignUpFactory as Any
        }
        localTable["inputActivityFactory-any InputActivityFactory"] = { [unowned self] in
            self.inputActivityFactory as Any
        }
        localTable["activityDetailFactory-any ActivityDetailFactory"] = { [unowned self] in
            self.activityDetailFactory as Any
        }
        ...
        localTable["lectureListDetailFactory-any LectureListDetailFactory"] = { [unowned self] in
            self.lectureListDetailFactory as Any
        }
        localTable["inputLectureFactory-any InputLectureFactory"] = { [unowned self] in
            self.inputLectureFactory as Any
        }
        localTable["lectureDetailSettingFactory-any LectureDetailSettingFactory"] = { [unowned self] in
            self.lectureDetailSettingFactory as Any
        }
        localTable["postListFactory-any PostListFactory"] = { [unowned self] in self.postListFactory as Any }
        localTable["postDetailSettingFactory-any PostDetailSettingFactory"] = { [unowned self] in
            self.postDetailSettingFactory as Any
        }
        ...
        localTable["noticeDetailFactory-any NoticeDetailFactory"] = { [unowned self] in
            self.noticeDetailFactory as Any
        }
        localTable["studentInfoFactory-any StudentInfoFactory"] = { [unowned self] in self.studentInfoFactory as Any }
        localTable["inputCertificationFactory-any InputCertificationFactory"] = { [unowned self] in
            self.inputCertificationFactory as Any
        }
        ...
        localTable["noticeDetailSettingFactory-any NoticeDetailSettingFactory"] = { [unowned self] in
            self.noticeDetailSettingFactory as Any
        }
        localTable["inputInquiryFactory-any InputInquiryFactory"] = { [unowned self] in
            self.inputInquiryFactory as Any
        }
        localTable["inquiryDetailFactory-any InquiryDetailFactory"] = { [unowned self] in
            self.inquiryDetailFactory as Any
        }
        localTable["writeInquiryAnswerFactory-any WriteInquiryAnswerFactory"] = { [unowned self] in
            self.writeInquiryAnswerFactory as Any
        }
        localTable["changePasswordFactory-any ChangePasswordFactory"] = { [unowned self] in
            self.changePasswordFactory as Any
        }
        localTable["successChangePasswordFactory-any SuccessChangePasswordFactory"] = { [unowned self] in
            self.successChangePasswordFactory as Any
        }
        localTable["userListFactory-any UserListFactory"] = { [unowned self] in self.userListFactory as Any }
        localTable["requestUserSignupFactory-any RequestUserSignupFactory"] = { [unowned self] in
            self.requestUserSignupFactory as Any
        }
        localTable["withdrawUserListFactory-any WithdrawUserListFactory"] = { [unowned self] in
            self.withdrawUserListFactory as Any
        }
        localTable["findPasswordFactory-any FindPasswordFactory"] = { [unowned self] in
            self.findPasswordFactory as Any
        }
        localTable["newPasswordFactory-any NewPasswordFactory"] = { [unowned self] in self.newPasswordFactory as Any }
        localTable["lectureApplicantListFactory-any LectureApplicantListFactory"] = { [unowned self] in
            self.lectureApplicantListFactory as Any
        }
        ...
        localTable["organizationListFactory-any OrganizationListFactory"] = { [unowned self] in
            self.organizationListFactory as Any
        }
        localTable["universityListFactory-any UniversityListFactory"] = { [unowned self] in
            self.universityListFactory as Any
        }
        localTable["inputOrganizationFactory-any InputOrganizationFactory"] = { [unowned self] in
            self.inputOrganizationFactory as Any
        }
        localTable["inputUniversityFactory-any InputUniversityFactory"] = { [unowned self] in
            self.inputUniversityFactory as Any
        }
        ...
        localTable["remoteWithdrawDataSource-any RemoteWithdrawDataSource"] = { [unowned self] in
            self.remoteWithdrawDataSource as Any
        }
        localTable["withdrawRepository-any WithdrawRepository"] = { [unowned self] in self.withdrawRepository as Any }
        localTable["fetchWithdrawUserListUseCase-any FetchWithdrawUserListUseCase"] = { [unowned self] in
            self.fetchWithdrawUserListUseCase as Any
        }
        localTable["remoteSchoolDataSource-any RemoteSchoolDataSource"] = { [unowned self] in
            self.remoteSchoolDataSource as Any
        }
        localTable["schoolRepository-any SchoolRepository"] = { [unowned self] in self.schoolRepository as Any }
        localTable["fetchSchoolListUseCase-any FetchSchoolListUseCase"] = { [unowned self] in
            self.fetchSchoolListUseCase as Any
        }
        localTable["fetchAllSchoolNameUseCase-any FetchAllSchoolNameUseCase"] = { [unowned self] in
            self.fetchAllSchoolNameUseCase as Any
        }
        localTable["createdSchoolUseCase-any CreatedSchoolUseCase"] = { [unowned self] in
            self.createdSchoolUseCase as Any
        }
        localTable["modifySchoolUseCase-any ModifySchoolUseCase"] = { [unowned self] in
            self.modifySchoolUseCase as Any
        }
        localTable["deleteSchoolUseCase-any DeleteSchoolUseCase"] = { [unowned self] in
            self.deleteSchoolUseCase as Any
        }
        localTable["fetchSchoolDetailUseCase-any FetchSchoolDetailUseCase"] = { [unowned self] in
            self.fetchSchoolDetailUseCase as Any
        }
        localTable["remoteEmailDataSource-any RemoteEmailDataSource"] = { [unowned self] in
            self.remoteEmailDataSource as Any
        }
        localTable["emailRepository-any EmailRepository"] = { [unowned self] in self.emailRepository as Any }
        localTable["sendEmailCertificationLinkUseCase-any SendEmailCertificationLinkUseCase"] = { [unowned self] in
            self.sendEmailCertificationLinkUseCase as Any
        }
        localTable["fetchEmailVertificationStatusUseCase-any FetchEmailVertificationStatusUseCase"] =
            { [unowned self] in
                self.fetchEmailVertificationStatusUseCase as Any
            }
        localTable["remoteCertificationDataSource-any RemoteCertificationDataSource"] = { [unowned self] in
            self.remoteCertificationDataSource as Any
        }
        localTable["certificationRepository-any CertificationRepository"] = { [unowned self] in
            self.certificationRepository as Any
        }
        localTable["fetchCertificationListByTeacherUseCase-any FetchCertificationListByTeacherUseCase"] =
            { [unowned self] in self.fetchCertificationListByTeacherUseCase as Any }
        localTable["fetchCertificationListByStudentUseCase-any FetchCertificationListByStudentUseCase"] =
            { [unowned self] in self.fetchCertificationListByStudentUseCase as Any }
        localTable["inputCertificationUseCase-any InputCertificationUseCase"] = { [unowned self] in
            self.inputCertificationUseCase as Any
        }
        localTable["updateCertificationUseCase-any UpdateCertificationUseCase"] = { [unowned self] in
            self.updateCertificationUseCase as Any
        }
        localTable["remoteCompanyDataSource-any RemoteCompanyDataSource"] = { [unowned self] in
            self.remoteCompanyDataSource as Any
        }
        localTable["companyRepository-any CompanyRepository"] = { [unowned self] in self.companyRepository as Any }
        localTable["fetchCompanyListUseCase-any FetchCompanyListUseCase"] = { [unowned self] in
            self.fetchCompanyListUseCase as Any
        }
        localTable["createdCompanyUseCase-any CreatedCompanyUseCase"] = { [unowned self] in
            self.createdCompanyUseCase as Any
        }
        localTable["deleteCompanyUseCase-any DeleteCompanyUseCase"] = { [unowned self] in
            self.deleteCompanyUseCase as Any
        }
    }
}
...
@inline(never) private func register1() {
    ...
    registerProviderFactory(
        "^->AppComponent->InputCertificationComponent",
        factory2810b45b31199a5f0c2af47b58f8f304c97af4d5
    )
    registerProviderFactory("^->AppComponent->ClubListComponent", factory050817f1b6d356b83467f47b58f8f304c97af4d5)
    registerProviderFactory(
        "^->AppComponent->LectureListDetailComponent",
        factory22af859a70aa8ba0b346f47b58f8f304c97af4d5
    )
    registerProviderFactory(
        "^->AppComponent->OrganizationListComponent",
        factory9677c02ce264ac0ad62df47b58f8f304c97af4d5
    )
    ...
    registerProviderFactory(
        "^->AppComponent->NoticeDetailSettingComponent",
        factory24d19202afbef2333be9e3b0c44298fc1c149afb
    )
    ...
    registerProviderFactory(
        "^->AppComponent->LectureApplicantListComponent",
        factory78a87c10d14f7bbaaa9df47b58f8f304c97af4d5
    )
