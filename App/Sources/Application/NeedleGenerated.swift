...
private func factory2c6c6f3f10221ceac3a8f47b58f8f304c97af4d5(_ component: NeedleFoundation.Scope) -> AnyObject {
    return AdminRequestUserSignupDependency260e3843e854d6971798Provider(
...
private func factory1ef284da45544ee52e3ef47b58f8f304c97af4d5(_ component: NeedleFoundation.Scope) -> AnyObject {
    return AdminWithdrawUserListDependency06942465f0ac1aaeda24Provider(
        appComponent: parent1(component) as! AppComponent
    )
}
...
extension AdminUserListComponent: Registration {
    public func registerItems() {
        keyPathToName[\AdminUserListDependency.adminRequestUserSignupFactory] =
            "adminRequestUserSignupFactory-any AdminRequestUserSignupFactory"
        keyPathToName[\AdminUserListDependency.adminWithdrawUserListFactory] =
...
extension AdminRequestUserSignupComponent: Registration {
    public func registerItems() {
        keyPathToName[\AdminRequestUserSignupDependency.adminUserListFactory] =
            "adminUserListFactory-any AdminUserListFactory"
        keyPathToName[\AdminRequestUserSignupDependency.adminWithdrawUserListFactory] =
            "adminWithdrawUserListFactory-any AdminWithdrawUserListFactory"
        keyPathToName[\AdminRequestUserSignupDependency.fetchUserListUseCase] =
            "fetchUserListUseCase-any FetchUserListUseCase"
        keyPathToName[\AdminRequestUserSignupDependency.approveUserSignupUseCase] =
            "approveUserSignupUseCase-any ApproveUserSignupUseCase"
        keyPathToName[\AdminRequestUserSignupDependency.rejectUserSignupUseCase] =
...
extension AdminWithdrawUserListComponent: Registration {
    public func registerItems() {
        keyPathToName[\AdminWithdrawUserListDependency.adminUserListFactory] =
            "adminUserListFactory-any AdminUserListFactory"
        keyPathToName[\AdminWithdrawUserListDependency.adminRequestUserSignupFactory] =
            "adminRequestUserSignupFactory-any AdminRequestUserSignupFactory"
        keyPathToName[\AdminWithdrawUserListDependency.fetchWithdrawUserListUseCase] =
            "fetchWithdrawUserListUseCase-any FetchWithdrawUserListUseCase"
        keyPathToName[\AdminWithdrawUserListDependency.withdrawUserUseCase] =
...
extension AppComponent: Registration {
    public func registerItems() {
        ...
        localTable["adminUserListFactory-any AdminUserListFactory"] = { [unowned self] in
            self.adminUserListFactory as Any
        }
        localTable["adminRequestUserSignupFactory-any AdminRequestUserSignupFactory"] = { [unowned self] in
            self.adminRequestUserSignupFactory as Any
        }
        localTable["adminWithdrawUserListFactory-any AdminWithdrawUserListFactory"] = { [unowned self] in
            self.adminWithdrawUserListFactory as Any
        }
...
@inline(never) private func register1() {
    ...
    registerProviderFactory(
        "^->AppComponent->AdminRequestUserSignupComponent",
        factory2c6c6f3f10221ceac3a8f47b58f8f304c97af4d5
    )
    registerProviderFactory(
        "^->AppComponent->LectureApplicantListComponent",
    ...
    registerProviderFactory(
        "^->AppComponent->AdminWithdrawUserListComponent",
        factory1ef284da45544ee52e3ef47b58f8f304c97af4d5
    )
    registerProviderFactory(
        "^->AppComponent->WriteInquiryAnswerComponent",
