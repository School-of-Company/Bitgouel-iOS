...
private class GovernmentListDependencyf4812d1ffdfb68a1daa0Provider: GovernmentListDependency {
    init() {}
}

/// ^->AppComponent->GovernmentListComponent
private func factory76b78e1e248880d50ed2e3b0c44298fc1c149afb(_ component: NeedleFoundation.Scope) -> AnyObject {
    return GovernmentListDependencyf4812d1ffdfb68a1daa0Provider()
}
...
extension LectureListDetailComponent: Registration {
    public func registerItems() {
        ...
        keyPathToName[\LectureListDetailDependency.cancelLectureUseCase] =
...
extension LectureDetailSettingComponent: Registration {
    public func registerItems() {
        ...
        keyPathToName[\LectureDetailSettingDependency.fetchInstructorListUseCase] =
            "fetchInstructorListUseCase-any FetchInstructorListUseCase"
        keyPathToName[\LectureDetailSettingDependency.fetchLineListUseCase] =
            "fetchLineListUseCase-any FetchLineListUseCase"
        keyPathToName[\LectureDetailSettingDependency.fetchDepartmentListUseCase] =
            "fetchDepartmentListUseCase-any FetchDepartmentListUseCase"
        keyPathToName[\LectureDetailSettingDependency.fetchDivisionListUseCase] =
...
extension GovernmentListComponent: Registration {
    public func registerItems() {}
}
...
extension LectureApplicantListComponent: Registration {
    public func registerItems() {
        ...
        keyPathToName[\LectureApplicantListDependency.modifyApplicantWhetherUseCase] =
...
extension AppComponent: Registration {
    public func registerItems() {
        ...
        localTable["cancelLectureUseCase-any CancelLectureUseCase"] = { [unowned self] in
            self.cancelLectureUseCase as Any
        }
        localTable["fetchInstructorListUseCase-any FetchInstructorListUseCase"] = { [unowned self] in
            self.fetchInstructorListUseCase as Any
        }
        localTable["fetchLineListUseCase-any FetchLineListUseCase"] = { [unowned self] in
            self.fetchLineListUseCase as Any
        }
        localTable["fetchDepartmentListUseCase-any FetchDepartmentListUseCase"] = { [unowned self] in
            self.fetchDepartmentListUseCase as Any
        }
        localTable["fetchDivisionListUseCase-any FetchDivisionListUseCase"] = { [unowned self] in
            self.fetchDivisionListUseCase as Any
        }
        ...
        localTable["modifyApplicantWhetherUseCase-any ModifyApplicantWhetherUseCase"] = { [unowned self] in
            self.modifyApplicantWhetherUseCase as Any
        }
        ...
        localTable["governmentListFactory-any GovernmentListFactory"] = { [unowned self] in
            self.governmentListFactory as Any
        }
...
@inline(never) private func register1() {
    ...
    registerProviderFactory("^->AppComponent->GovernmentListComponent", factory76b78e1e248880d50ed2e3b0c44298fc1c149afb)
